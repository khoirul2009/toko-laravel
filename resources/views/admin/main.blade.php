      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item {{ $menu == 'produk' ? 'open active' : '' }}">
              ...
              <ul class="menu-sub">
                <li class="menu-item {{ Request::is('admin/produk') ? 'active' : '' }}">
                  <a href="/admin/produk" class="menu-link">
                    <div data-i18n="Without menu">Kelola Produk</div>
                  </a>
                </li>
            ...
            <li class="menu-item {{ $menu == 'users' ? 'open active' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <ul class="menu-sub">
                <li class="menu-item {{ Request::is('admin/user-pelanggan') ? 'active' : '' }}">
                  <a href="/admin/user-pelanggan" class="menu-link">
                    <div data-i18n="Without menu">Pelanggan</div>
                  </a>
                </li>
                <li class="menu-item {{ Request::is('admin/user-admin') ? 'active' : '' }}">
                  <a href="/admin/user-admin" class="menu-link">
